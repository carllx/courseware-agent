...
2. **多力竞争与动态平衡 (Competing Forces & Equilibrium)**
   ...
   ![](images/6c6afce155471570904aa4cb7f1b72760fd90675bf37df9b366794302e694a6d.png)
   *（图：基于多力竞争形成的力导向布局平衡态）*
3. **隐式数据注入 (Data Augmentation)**
   引擎在初始化时，会自动将位置、速度等力学相关的隐藏数据（如 `x`, `y`, `vx`, `vy`）注入到原始节点数组中，构筑物理演算的底层数据结构。
   ![](images/e8f581aaf79ae487985d34fc05a85a8577ba3dafbebcfc1080a29a58fc68e06d.png)
   *（图：引擎自动注入的辅助物理参数）*
...
![](images/a2a02970aff0787918cb24f04f4c377d57ca9c700dbb0333f1fd6269ac0d3ced.png)
![](images/7da70141f09835219fac09fa1b84035094a00a9afd7deff0c2fa265b64c90d20.png)
...
2. **分级色彩地图的感知偏差 (Perceptual Limitations of Choropleths)**
   ...
   ![](images/c85bffdeedc339f45d2958a560f4346bdeafb249c7548373d59f3048ee0b08c3.png)
