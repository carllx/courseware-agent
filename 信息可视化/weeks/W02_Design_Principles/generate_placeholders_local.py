...
images = {
    ...
    # M04
    "S07_Data_Ink_Ratio": "概念:Tufte-Data_Ink_Ratio对比",
    "S07c_Erasing_Steps": "教材:Tufte著名删减四步法名场面",
    "S07d_3D_Pie_Sins": "案例:3D透视饼图反面教材",
    "S07d2_Eyes_Beat_Memory": "概念:Tufte-小多图分面示例",
    "S07e_No_Unjustified_3D": "法则:Munzner-No_Unjustified_3D",
    
    # M05
    "S08_The_Black_Museum": "案例:信息犯罪黑历史3大怪图并列",
}

if not os.path.exists("public/textbook"):
    os.makedirs("public/textbook")
...
for slide, text in images.items():
    img = Image.new('RGB', (1920, 1080), color = '#1A191C')
    d = ImageDraw.Draw(img)
    full_text = f"TEXTBOOK ASSET\n\n{text}\n\n(Waiting for Manual Replacement)"
    text_color = '#E6B828'
    d.text((100, 400), full_text, fill=text_color, font=font)
