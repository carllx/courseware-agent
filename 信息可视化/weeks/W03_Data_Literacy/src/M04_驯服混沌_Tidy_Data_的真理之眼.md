...
> *   **Layout**: `Grid`
> *   **Scene**: 一张典型的 B 站视频数据报表（大宽表）。顶部表头横跨“2023上半年”与“2023下半年”，左侧行头混合了“动画区”、“游戏区”及多层嵌套的合并单元格，带着花哨的底色。
...
> *   **Layout**: `Grid`
> *   **Scene**: 经典文献《Tidy Data》封面，一旁列出三条被高亮的格式铁律。
> *   **List**:
>     - 每个 Attribute 独立成一列
>     - 每个 Item 独立成一行
>     - 每种观测单元独立成一表
...
> *   **Text**: "格式反模式：清理结构畸变"
> *   **Asset**: ![预览](../public/slides/S34a_Anti_Pattern_Demons.webp)
...
把横向排布的“2023上半年”、“2023下半年”统统收纳到统一叫作“时间”的一列中。这样一来，列数变少了，行数变长了，变成了名副其实的“长表”。不要小看这个机械的格式动作，它不仅是迎合机器，更是让数据解除束缚——只有化为长表，机器才能立刻进行切片与钻取，瞬间暴露出“哪个分区的播放量在异常暴跌”的**业务洞察**。
...
> *   **Asset**: ![预览](../public/slides/S35c_Demo_Station_3.webp)
