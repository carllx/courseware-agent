...
> *   **List**: 
    ...
    * HSL 是人类视觉视网膜的感性母语
    * 像调节收音机一样直觉掌控色彩
> *   **Asset**: ![预览](../public/slides/w07-slide-17.webp)
...
> *   **Asset**: ![预览](../public/slides/w07-slide-18.webp)
...
> [ACTIVITY]
> **[设计反直觉] HSL 参数的极速拆解**
> （试着回忆或是打开一个原型设计工具，选定一个你极其喜欢的品牌主色（比如微信绿）。如果在保持色相(H)完全死死不动的情况下，仅仅单纯去暴力改变饱和度(S)与亮度(L)的滑块值，你能快速配出能够适配于不同状态（如鼠标悬停 Hover、按下 Active）下的协调衍生色彩吗？体会这种彻底脱离 HEX 束缚的调色控制感。）
...
> *   **List**: 
    ...
    * 系统级开发需要极端的面状火力覆盖
    * 面向极限气候的工业原子化色彩法则
> *   **Asset**: ![预览](../public/slides/w07-slide-19.webp)
...
> *   **Asset**: ![预览](../public/slides/w07-slide-20.webp)
...
> *   **Asset**: ![预览](../public/slides/w07-slide-21.webp)
