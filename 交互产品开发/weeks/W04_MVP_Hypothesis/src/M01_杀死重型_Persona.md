...
在传统的产品开发（甚至很多同学的期末大作业）中，"用户画像 (Persona)" 往往是一份为了应付汇报而编写的厚重文档。大家去网上抄一堆数据，拼凑出一份精美的报告，假装很懂用户。但这种传统做法存在致命隐患：
...
> **Layout**: Split
> **Scene**: 展现一个由设计师、程序员和产品经理组成的团队，正像雕塑师一样在会议室里围着一块白板，快速用马克笔、便利贴和粗糙的纸片共同“雕塑”出一个虚拟用户的生动轮廓。画面充满快节奏、敏捷迭代和团队共识的协作能量。
> **Text**: 画板革命：先假设再验证
...
这种做法最大的价值在于**建立团队共识 (Shared Understanding)**。很多时候小组做大作业会吵架，是因为每个人脑子里想象的“用户”都不一样。Proto-Persona 能让所有人在动手做设计前，脑海中浮现出同一个具体的用户形象，从而减少不必要的沟通摩擦。
...
5. **模版具象化（从散落标签到人设卡片）**：白板上的标签依然是零散的。现在，针对每一个行为聚类拿出一张 A4 纸，随手画一个简笔画头像赋予其“实体”，然后将归类好的行为标签、深层动机和痛点，结构化地转移到这张纸上——这就是我们在下一节（1.4）将要详细拆解的“四大标准模块”。
6. **交叉审视**：小组成员互相交换这些刚画好的 A4 人设卡片，互相“找茬”，指出行为特征与痛点之间逻辑断裂或过于理想化的地方。
7. **外部验证**：拿着初稿找团队之外的同学或潜在用户看一眼，听听客观意见，避免陷入团队的自嗨。
...
**模块二：行为核心特征 (Behavioral Quirks)。** 这是指导设计的核心，也是大家最容易踩空掉入“人口学陷阱”的死亡区域。
...
很多时候，画像模板只在下半区含糊地写上“目标与需求”。但在实战中，这种粗颗粒度的标签毫无用处。比如，当用户说他需要一个“打卡功能”时，如果你不去深究，最后做出来的界面只会是一个冷冰冰的签到日历，沦为盲目堆砌功能的机器。

因此，在**模块三**，你必须将用户的诉求拆解为我们在前置课程学过的 **JTBD 三个维度：功能任务 (Functional)、社会任务 (Social) 和情感任务 (Emotional)**。只有通过 5-Whys 往下挖，你可能才会发现，用户要“打卡”的深层情感动机其实是“缓解一个人备考的孤独感，渴望同伴的认可”。

最后，在**模块四**，你必须用一句话进行最终的收敛，即**痛点陈述 (Problem Statement)** 公式：**【具象用户】非常需要【动词+任务】，因为【深层动机】**。
...
> **Answer**: `C`
> **Explain**: 年龄、收入、居住地等属于传统人口统计学标签（表面社会属性），无法决定用户在界面前的真实操作偏好（选项A、D错误）。选项 C 精准描述了系统交互层面的直觉与操作习惯（底层行为习惯），这才是指导界面架构的硬指标。选项 B（视力退化）属于生理阻碍，应放入下半区的 Obstacles（障碍）栏，而非右上角的行为特征区。
...
>
> **第三关折戟沉沙：**
> 就在团队摩拳擦掌准备动手画界面、写代码前，他们做了最后一次实战探测。
> 交互主考官面对那群天天抱怨的投资人，抛出了终极拷问：“既然我们的平台能完美解决看文档的痛点，各位是否愿意为此每月支付几百美金订阅费？或者，每天哪怕多花二十分钟，去专门学习并操作这套新系统？”
>
> 瞬间，原本满地诉苦的面孔开始闪烁其词。
...
> [TEACHING MOMENT]
> **不要让假定变成教条**
> 大家在做验证的时候，要警惕心理学上的“确证偏误 (Confirmation Bias)”。当你亲手画出一个 Proto-Persona 时，潜意识里往往会排斥那些推翻你预设的负面反馈。
...
> 这个团队被迫在机场大厅当场撕毁了原来的白板纸，重新画出了一个“极度疲惫、极简决策、厌恶选择”的全新受众画像。如果不经历这种现场被打脸的剧痛，他们会在那些看似华丽但没人用的航班比价交互上，浪费掉整整半个月的精力。
