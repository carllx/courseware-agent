...
# Persons aren't as useful as involving real people
...
Construct two to four more questions for each variable that ask the same question in a different way. This helps ensure that participants are answering accurately.   
...
Persons are extremely useful tools, but they certainly are not the only tool to help model users and their environment. Holtzblatt and Beyer's Contextual Design (Morgan Kaufmann, 1993) provides a wealth of information on the models briefly discussed here.
