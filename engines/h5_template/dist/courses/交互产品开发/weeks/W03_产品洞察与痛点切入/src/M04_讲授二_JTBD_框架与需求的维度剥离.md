...
作为千万年进化中存活下来的终极狩猎者，人类也是地球上最装腔作势、但也最敏感胆怯的群居动物。我们在掏钱雇佣一个产品时，我们的大脑皮层和边缘系统会同时爆发三个维度的疯狂并行计算：**功能性任务（Functional Job）**、**社会性任务（Social Job）**、**情感性任务（Emotional Job）**。这构成了 JTBD 的经典三维解构法则。

**(Pause: 3s)**

**维度一：功能性任务（Functional Job）**。
这是维持一个产品不下架、不被拉黑的最基础的保底生存维度。你的这把物理剪刀，到底能不能极其顺滑地把硬纸板剪开？你的这个地图导航 App，能不能用最短的耗时帮我完整规划出从 A 点到 B 点的最优公交换乘路线？
如果一个产品在这一层物理层面直接失效甚至宕机，一切用户体验免谈，直接火葬场。但请你们记住，在如今的技术爆炸和极其内卷的市场下，如果所有一线的竞争对手都能像你们一样完美做到功能性达标，这里的红海厮杀将会极其残酷。功能，永远无法构成护城河。

**维度二：社会性任务（Social Job）**。
这是每一个处于社会网络节点上的用户，在按下"下单付款"按钮前，潜意识深处对自己的那句致命拷问：**"如果我今天使用了这个狗屎产品，我在我的老板、难搞的同事、极度挑剔的客户、或者鄙视链对面的竞争对手眼里，看起来会是一个什么样形象的人？"**
我们为什么放着 9.9 包邮的不知名极其结实耐磨的帆布大包不买，而是要咬碎牙关、甚至去办理高利息的信用卡分期付款，去拼命买一只充满极简设计哲学的所谓奢侈品手袋？这只昂贵的包在功能性上甚至极其脆弱极容易刮花，容量小得连一把遮阳伞都毫无尊严地塞不下。但我们真正砸下几万块钱雇佣它的"社会层面属性"是——"我必须让今晚高级晚宴上的那些势利眼的前同事们，在看到我的第一秒钟就深深地确认，我已经极其彻底地脱离了十年前那个可怜寒酸的底层打工仔阶层"。
在中国广袤而充满激烈竞争的市场环境下，由于极其强横的面子文化和社会标签绑定，社会性任务的权重，经常极其残暴地碾压并且摧毁功能性任务。
...
**维度三：情感性任务（Emotional Job）**。
在这个极度私密的核反应堆里，外界一切的喧嚣围观和社交面具全部被硬生生剥落退散。这是每一个脆弱的用户在他一个人深夜独自面对镜子时，对自己发出的最后一道最残酷的灵魂拷问：**"当我用手指划过这个东西的屏幕时，我内心最深处，是感受到了一丝踏实的安全感，还是那种面临失控边缘的巨大恐慌感？"**
这，才是唯一能决定一个伟大产品能否获得绝对黏性、甚至让用户产生信仰崇拜的最高壁垒。
