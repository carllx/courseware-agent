...
def get_workspace_root() -> str:
    """获取工作区根目录（脚本位于 <workspace>/.agent/scripts/core/）"""
    # __file__ is .agent/scripts/core/script_parser.py
    # .parent is core/
    # .parent.parent is scripts/
    # .parent.parent.parent is .agent/
    # .parent.parent.parent.parent is workspace root
