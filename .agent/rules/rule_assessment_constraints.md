...
## 4. 期末考核类型约束 (Assessment Type Enum)

在定义期末考核大作业的具体分类（`final_item.assessment_type`）时，**必须**从以下官方支持的考核方式中选择：
- **大作业**
- **论文**
- **口试**
- **实际操作**

*(注：历史文档中曾出现的“实操类”、“报告”、“演示类”、“实物类”等非标表述已废弃，需统一映射为上述标准分类，例如“实操类”统一修正为“实际操作”。)*
